<div class="w-screen flex justify-center pt-[120px]">
    ...
    <div class="h-[305px] w-[800px] flex relative">
        ...
        <div class="absolute top-[0%] left-[0%] w-full h-full flex justify-center items-center z-[20]">
            <p class="font font-30px font-semibold max-w-[680px] flex text-center inline-block ">Life Is Like A Bicycle, To Keep Your Balance, You Must Keep Moving.</p>
        </div>
        ...
        <div class="absolute top-0 left-0 z-[20]">
            <img class="h-[70px]" src="/svgs/home/message-logo.svg" alt="">
        </div>


        <div class="absolute bottom-0 right-0 z-[20]" style="transform: rotatey(180deg);">
            <img class="h-[70px]" src="/svgs/home/message-logo.svg" alt="">
        </div>
