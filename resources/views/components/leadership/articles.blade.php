<div class="article-container w-screen h-[120vh]  main-container flex flex-row gap-[15px] pt-[40px]">
    ...
    <div class="w-[70%] h-full flex flex-row bg-white " style="box-shadow: 0px 0px 30px #00000012;">
        ...
        <div x-data="{ showFirst: true }" class="w-full h-full flex flex-col gap-[40px] ">
            ...
            <div class="flex flex-col gap-[15px] pt-[30px] px-[50px]">
                ...
                <div class="flex flex-row gap-[15px]">
                    <button :class="{ 'active': showFirst ,'button': !showFirst }" @click="showFirst = true" class="w-[150px] h-[35px] border-[1px] font-semibold font fonnt-16px border-black">English</button>
                    <button :class="{ 'active': !showFirst ,'button': showFirst }" @click="showFirst = false" class="w-[150px] h-[35px] border-[1px] font-semibold font fonnt-16px border-black">Arabic</button>
                </div>
            </div>
            ...
            <div class="flex flex-row w-full h-full">
                ...
                <div x-show="showFirst" class="w-full h-full fex flex-col gap-[30px] ">
                    ...
                    <div class="article relative h-[55px] px-[50px] border-t-[1px] border-collapse">
                        ...
                        <div class="asolute top-0 left-0 w-full h-full  flex flex-row justify-between items-center">
                            <p class="font font-16px font-semibold text-[#135D66]">The Global Leader Of Today</p>
                            <p class="font font-normal font-16px">18-4-2024</p>

                            <div class="w-[150px] h-[32px]  relative ">
                                ...
                                <div class="absolute top-0 left-0 w-full h-full flex flex-row gap-[10px] justify-center items-center cursor-pointer">
                                    ...
                                    <p class="text-[#135D66] flex justify-center items-center font font-14px font-medium">
                                        Download
                                    </p>
                                </div>
                            </div>
                ...
                <div x-show="!showFirst" class="w-full h-full fex flex-col gap-[30px] ">
                    ...
                    <div class="article relative h-[55px] px-[50px] border-t-[1px] border-collapse">
                        ...
                        <div class="asolute top-0 left-0 w-full h-full  flex flex-row justify-between items-center">
                            ...
                            <p class="font font-normal font-16px">18-4-2024</p>
                            <p class="font font-16px font-semibold text-[#135D66]">مزايا وتحدّيات استقلالية المصارف المركزية: حالة مصرف لبنان</p>
    ...
    <div class="w-[30%] h-full flex flex-col pt-[20px] px-[20px] gap-[40px] bg-white " style="box-shadow: 0px 0px 30px #00000012;">

        @foreach($leaderships as $leadership)
        <div class="w-full h-[auto]  flex flex-col  ">
            <div class="flex flex-row gap-[20px] h-[26%]  items-center">
