    ...
    <div class="w-full flex flex-col gap-[15px]">
        ...
        <div class="form-inputs flex flex-row gap-[30px] w-full">
            ...
            <div class="w-full flex flex-col gap-[5px]">
                ...
                <input wire:model="phone" placeholder="Phone Number" class="w-full input-2 text-[13px] h-[35px] border-[1px] border-collapse px-[10px]" type="tel" name="phone" id="phone" required>
            </div>
        </div>
